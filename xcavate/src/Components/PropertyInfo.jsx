      ...
      <div className="container mt-10 m-auto flex justify-center items-center flex-col h-[100%]">
        ...
        >
          <form>
            ...
            <label
              for="id"
              class="block mb-4 mt-3 text-sm font-medium text-gray-900 dark:text-gray-500 "
            >
            ...
            <div class="grid md:grid-cols-4 md:gap-2">
              <div className="flex flex-col justify-center items-center">
                ...
                <input
                  type="text"
                  id="ptype"
                  class="shadow-sm mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
